...
export default function AgentScanErrand() {
  ...
  const handleScan = async (trackingNumber: string) => {
    ...
    try {
      ...
      if (pkg.delivery_type !== 'errand') {
        toast.error('Action not allowed', { description: 'This is not an errand package.' });
        return;
      }
      ...
      toast.success('Errand package received!', { description: trackingNumber });
    } catch {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="px-4 pt-4 pb-3 border-b border-border flex items-center gap-3">
        ...
        <h1 className="font-display text-lg font-bold">Scan Errand Packages</h1>
      </div>

      <div className="px-4 pt-8 text-center">
        <p className="text-muted-foreground mb-4">Scan an errand package QR code to process it.</p>
